...
st.markdown(
    ...
    <div style="text-align: center; color: gray; margin-top: 20px;">
        <p><strong>House Price Predictor</strong> — MLOps Bootcamp 2026</p>
        <p>by <a href="https://github.com/GonzaloMardones/house-price-predictor" target="_blank">Gonzalo Mardones</a></p>
